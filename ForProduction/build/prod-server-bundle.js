...
var map = {
	...
	"./Profile.js": "./src/components/Profile.js",
...
var _importCss2 = __webpack_require__("./node_modules/babel-plugin-universal-import/importCss.js");

var _importCss3 = _interopRequireDefault(_importCss2);

var _universalImport2 = __webpack_require__("./node_modules/babel-plugin-universal-import/universalImport.js");
...
var getBundle = function getBundle() {
    (0, _universalImport3.default)({
        id: 'lodash',
        file: 'C:/Users/mario/Desktop/ude/webpack-practice/ForProduction/src/components/Gallery.js',
        load: function load() {
            return _promise2.default.all([new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, "lodash")), (0, _importCss3.default)('lodash', {})]).then(function (proms) {
                return proms[0];
            });
        },
        path: function path() {
...
var UniversalComponent = (0, _reactUniversalComponent2.default)(function (props) {
    return (0, _universalImport3.default)({
        id: './',
        file: 'C:/Users/mario/Desktop/ude/webpack-practice/ForProduction/src/components/Routes.js',
        load: function load() {
            return _promise2.default.all([__webpack_require__("./src/components lazy recursive ^\\.\\/.*$")("./" + props.page), (0, _importCss3.default)('' + props.page, {})]).then(function (proms) {
                return proms[0];
            });
        },
        path: function path() {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                { exact: true, path: '/' },
                _react2.default.createElement(UniversalComponent, { page: 'Profile' })
            ),
            _react2.default.createElement(
                _reactRouterDom.Route,
                { path: '/about' },
